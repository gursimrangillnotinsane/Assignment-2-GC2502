● Developed a Java-based GUI using JavaFX, resulting in a responsive application that processes and displays data from an open api. Achieved a 100% project score.
